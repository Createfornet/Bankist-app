...
const account2 = {
  ...
  movementsDates: [
    ...
    '2024-01-20T16:33:06.386Z',
    '2024-01-29T14:43:26.374Z',
...
const colorEven = () => {
  Array.from(document.querySelectorAll('.movements__row')).forEach((row, i) => {
    if (i % 2 === 0)
      row.style.background = 'linear-gradient(to left, #eee, #fff)';
  });
};
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const movDate = formatMovDate(new Date(acc.movementsDates[i]));
    const html = `
